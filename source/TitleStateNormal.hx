...
class TitleStateNormal extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(10, -30);
		logoBl.frames = FlxAtlasFrames.fromSparrow('assets/images/jokelogo.png', 'assets/images/jokelogo.xml');
		...
		gfDance.frames = FlxAtlasFrames.fromSparrow('assets/images/Draco.png', 'assets/images/Draco.xml');
