...
class Startup extends MusicBeatState
{
    ...
    var songs:Array<String> =   ["Keem VS Craniacs"];
    ...
    var characters:Array<String> =   ["BOYFRIEND", "Keem", "Draco"];

    var graphicsCached:Bool = Main.skipgraphics;
    var graphics:Array<String> =    ["jokelogo", "titleBG", "gfDanceTitle", "titleEnter"];
