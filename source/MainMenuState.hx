...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		gfDance = new FlxSprite(0, FlxG.height * 0.2);
		gfDance.frames = Paths.getSparrowAtlas("Draco");
		gfDance.animation.addByIndices('danceLeft', 'Drac', [0, 1, 2, 3, 4], "", 24, false);
		gfDance.animation.addByIndices('danceRight', 'Drac', [5, 6, 7, 8, 9], "", 24, false);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					#if linux
					Sys.command('/usr/bin/xdg-open', ["https://www.youtube.com/user/NewDramaAlert", "&"]);
					#else
					FlxG.openURL('https://www.youtube.com/user/NewDramaAlert');
					#end
				}
				...
				{
					#if linux
					Sys.command('/usr/bin/xdg-open', ["https://www.youtube.com/channel/UCJj91yPSruvqylY9WEsQCiw", "&"]);
					#else
					FlxG.openURL('https://www.youtube.com/channel/UCJj91yPSruvqylY9WEsQCiw');
					#end
				}
				else
				{
